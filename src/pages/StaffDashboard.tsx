...
import { BookOpen, FileText, LogOut, CheckCircle2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto max-w-3xl px-6 py-12">
        <div className="mb-10">
          ...
          <p className="mt-2 text-muted-foreground">Select a subject, then upload the question paper and answer key.</p>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {SUBJECTS.map((subject) => (
              <button key={subject} onClick={() => { setSelectedSubject(subject); setUploaded(false); }}
        ...
        {selectedSubject && (
          <div className="space-y-6 animate-in fade-in-0 slide-in-from-bottom-4 duration-300">
            <h2 className="text-sm font-semibold text-foreground">Upload Files — {selectedSubject}</h2>
